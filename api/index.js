...
let db = mongoose.connection,
    dburl = 'mongodb://mariela:bonilla34@ds247944.mlab.com:47944/examen_ampliacion',
    port = 4000;
...
const hoteles = require('./componentes/hoteles/hoteles.route');
...
function _server(){
  console.log('Se estableció la conexión en el puerto ' + port);
};